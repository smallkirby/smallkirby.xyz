...
const likes: Like[] = [
    ...
    ents: [
      {
        ...
        description: 'DX(GC,2001), X(Wii,2008), Special(Switch,2018)',
      },
      {
      ...
      {
        name: 'Monster Hunter',
        description: 'P2G(PSP,2008), P3(PSP,2010), 3(Wii,2009), World(PS4,2018), Rise(switch,2021)',
      },
      {
        name: 'Persona 5',
  ...
  },
  {
    ...
    ents: [
      ...
      {
        name: '世界の終りとハードボイルド・ワンダーランド (Hard-Boiled Wonderland and the End of the World)',
  ...
  },
  {
    ...
    ents: [
      {
        name: 'Big katsu',
        link: 'https://ja.wikipedia.org/wiki/%E3%83%93%E3%83%83%E3%82%B0%E3%82%AB%E3%83%84',
      },
      {
        name: 'Kabayaki san',
        link: 'https://ja.wikipedia.org/wiki/%E8%92%B2%E7%84%BC%E3%81%95%E3%82%93%E5%A4%AA%E9%83%8E',
      },
      {
        name: 'Oshaburi Kombu',
      },
  ...
  },
  {
    ...
    ents: [
      ...
      {
        name: 'はじめまして松尾です',
        link: 'https://www.youtube.com/c/%E3%81%AF%E3%81%98%E3%82%81%E3%81%BE%E3%81%97%E3%81%A6%E6%9D%BE%E5%B0%BE%E3%81%A7%E3%81%99hajimemashite',
      },
      {
        name: '美術2の人',
...
export default Vue.extend({
  ...
  data () {
    return {
      titleMsg: '$ find /home/smallkirby/likes/ -type f | xargs grep like | grep -v lazy',
      mylikes: likes,
      flagTitleMsg: false,
    }
  },
