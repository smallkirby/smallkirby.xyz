    ...
    <div class="w-full mx-1 my-2 p-2 border border-skwhite rounded-lg flex">
      ...
      <div class="flex flex-col w-full mr-2">
        ...
        <div class="mt-1 flex w-full md:w-1/2 justify-between mx-auto">
          ...
          >
            <img
              :src="current_fukidashi_image"
              class="w-6 fill-white"
              @mouseover="flip_fukidashi_mouseon"
              @mouseleave="flip_fukidashi_mouseon"
            >
          </a>
          <a
          ...
          >
            <img
              :src="current_retweet_image"
              class="w-6 fill-white"
              @mouseover="flip_retweet_mouseon"
              @mouseleave="flip_retweet_mouseon"
            >
          </a>
          <a href="https://kaguya.love" target="_blank">
            <img
              :src="current_fav_image"
              class="w-6 fill-white"
              @mouseover="flip_fav_mouseon"
              @mouseleave="flip_fav_mouseon"
            >
          </a>
        </div>
      </div>
...
export default Vue.extend({
  ...
  computed: {
    ...
    current_fav_image: function () {
      return (this.$data as any).fav_image_mouseon
        ? require('~/static/img/sotsuron/heart-br.png')
        : require('~/static/img/sotsuron/heart.png');
    },

    // eslint-disable-next-line object-shorthand
    current_fukidashi_image: function () {
      return (this.$data as any).fukidashi_image_mouseon
        ? require('~/static/img/sotsuron/fukidashi-zzz.png')
        : require('~/static/img/sotsuron/fukidashi.png');
    },

    // eslint-disable-next-line object-shorthand
    current_retweet_image: function () {
      return (this.$data as any).retweet_image_mouseon
        ? require('~/static/img/sotsuron/retweet-white.png')
        : require('~/static/img/sotsuron/retweet.png');
    },
  },
  ...
  methods: {
    ...
    flip_fukidashi_mouseon () {
      (this as any).fukidashi_image_mouseon = !(this as any)
        .fukidashi_image_mouseon;
    },
    flip_retweet_mouseon () {
      (this as any).retweet_image_mouseon = !(this as any)
        .retweet_image_mouseon;
    },
  },
});
</script>
